...
public class ResponseUtil {
     ...
     *  返回一个空字符串
     * */
    public static ResponseEntity<JSONArray> getResEntityForGet(List<?> list) {
        String arrs= JSONArray.toJSONStringWithDateFormat(list,"yyyy-MM-dd HH:mm:ss");
        return new ResponseEntity<JSONArray>(JSONArray.parseArray(arrs), HttpStatus.OK);
    }
