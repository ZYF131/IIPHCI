        ...
        $(window).load( function(){
            ...
            if(page.totalPage>3)
            {
                ...
                if(one>page.totalPage) {
                    ...
                    html2="<li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/1'>Home</a></li><li class='disabled'><a href=''>CurrPage:"+page.currPage+" </a></li><li class='disabled'><a href=''>Total:"+page.totalPage+" </a></li><li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+up+"'>Previous</a></li><li class='active'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+one+"'>"+one+"<span class='sr-only'></span></a></li><li><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+two+"'>"+two+"</a></li><li><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+three+"'>"+three+"</a></li><li><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+down+"'>Next</a></li><li><a href='${cx}/api/tResource/getStuEnglish/"+id+"/"+page.totalPage+"'>Last</a></li>";
            ...
            else
            {
                switch (page.totalPage) {
                    case 1:
                        html2="<li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/1'>1</a></li>";
                        break;
                    case 2:
                        html2="<li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/1'>1</a></li><li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/2'>2</a></li>";
                        break;
                    case 3:
                        html2="<li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/1'>1</a></li><li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/2'>2</a></li><li class='disabled'><a href='${cx}/api/tResource/getStuEnglish/"+id+"/3'>3</a></li>";
                        break;
                    default:
                        break
                }
...
<div class="content">
    ...
    <div class="se-nav" style="background:url(${cx}/resource/res/sites/images/twain-bg.png) no-repeat;background-size: cover;">
        <h3>Sports imagination EEG data download</h3>
    </div>
                ...
                <div class="section section_0">
                    <div class="mainWrap">
                        <div class="section_0_1">
                            <ul id="ul_tstudent">
                                <li><a href="/index/api/tNews/toNewsInfo/7">Subject OYR★</a>
                            ...
                            <nav>
                                <ul class="pagination" id="contr">
                                    ...
                                    <li>
                                        <a href="/student/student/list?page=2&amp;size=10">Next</a>
                                    </li>
                                    <li>
                                        <a href="/student/student/list?page=5">Last</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
