            ...
            //var json=page.list;
              ...
              var  jsonsub=json.lists;
                for(var i = 0 ; i  < jsonsub.length ; i++){
                    ...
                    html+="<li><a href='${cx}/api/tResource/getStu/"+jsonsub[i].subid+"/1'>"+jsonsub[i].enabname+"</a><b><bstyle='float: right; font-weight: normal;'></b></li>";
               ...
               var page=json;
                ...
                if(page.totalPage>3)
                {
                    ...
                    if(one>page.totalPage)
                    {
                        ...
                        html2+="<li class='disabled'><a href='${cx}/api/subjectinfo/getStu/1'>首页 </a></li><li class='disabled'><a href=''>当前页:"+page.currPage+" </a></li><li class='disabled'><a href=''>共:"+page.totalPage+"页 </a></li><li class='disabled'><a href='${cx}/api/subjectinfo/getStu/"+up+"'>上一页</a></li><li class='active'><a href='${cx}/api/subjectinfo/getStu/"+one+"'>"+one+"<span class='sr-only'></span></a></li><li><a href='${cx}/api/subjectinfo/getStu/"+two+"'>"+two+"</a></li><li><a href='${cx}/api/subjectinfo/getStu/"+three+"'>"+three+"</a></li><li><a href='${cx}/api/subjectinfo/getStu/"+down+"'>下一页</a></li><li><a href='${cx}/api/subjectinfo/getStu/"+page.totalPage+"'>尾页</a></li>";
                    }
                    ...
                    <div class="mainWrap">
                        <div class="section_0_1">
                            <ul id="ul_tstudent">
                                    ...
                                    <li><a href="/api/tResource/getAllBy/${u.subid}">受试者OYR★${u.enabname }</a>
                            ...
                            <nav>
                                <ul class="pagination" id="ul_di">
                                            <li class="disabled">
                                                <a href="${cx}/api/subjectinfo/getStu/1">首页 </a>
                                            </li>
                                            <li class="disabled">
                                                <a href="${cx}/api/subjectinfo/getStu/${requestScope.pagemsg.currPage-1}">上一页 </a>
                                            </li>
                                            <li class="active">
                                            ...
                                            <li>
                                                ...
                                                <li>
                                                    <a href="${cx}/api/subjectinfo/getStu?currentPage=${page.currPage+1}">下一页</a>
                                                </li>
                                                <li>
                                                    <a href="${cx}/api/subjectinfo/getStu?currentPage=${page.totalPage}">尾页</a>
                                                </li>
                                </ul>
                            </nav>
                        </div>
