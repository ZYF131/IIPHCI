...
<head>
    ...
    <link href="${pageContext.request.contextPath}/resource/css/base.css" type="text/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resource/css/tab.css" type="text/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resource/css/item.css" type="text/css" rel="stylesheet">
    <link href="${pageContext.request.contextPath}/resource/css/item_do.css" type="text/css" rel="stylesheet">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/resource/css/uploadify.css" type="text/css"></link>
    ...
    <script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/jquery.uploadify.v2.0.3.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/swfobject.js"></script>
        <%
...
<table id="dg" title="图片信息管理" class="easyui-datagrid" pagination="true"
       ...
       url="${pageContext.request.contextPath}/resource/picture/list.do?type=<%=type %>&grade=<%=grade %>"
       toolbar="#tb">
...
<script type="text/javascript">
    ...
    function deletePicture() {
        ...
        $.messager.confirm("系统提示", "您确认要删除这<font color=red>"
            ...
            if (r) {
                $.post("${pageContext.request.contextPath}/resource/picture/delete.do",
                    {
                        ids: ids
                    }, function (result) {
                        if (result.success) {
    ...
    function openPictureAddDialog() {
        ...
        initUploadify();
        url = "${pageContext.request.contextPath}/resource/picture/save.do";
    }
    ...
    function openPictureModifyDialog() {
        ...
        $('#fm').form('load', row);
        url = "${pageContext.request.contextPath}/resource/picture/save.do?id="
            + row.id;
    }

    function formatProPic(val, row) {
        return "<img width=100 height=100 src='${pageContext.request.contextPath}/resource/" + val + "'>";
    }
