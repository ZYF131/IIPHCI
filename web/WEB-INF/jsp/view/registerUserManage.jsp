...
<head>
    ...
    <title>registerUserManger</title>
...
<table id="dg" title="注册用户信息管理" class="easyui-datagrid" pagination="true"
       rownumbers="true" fit="true" data-options="pageSize:10"
       url="${pageContext.request.contextPath}/api/tbUser/listHoutai" toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>

        <th field="id" width="10%" align="center" hidden="true">id</th>
        <th field="usernc" width="200" align="center">用户名</th>
        <th field="truename" width="200" align="center">姓名</th>
        <th field="email" width="200" align="center">邮箱</th>

        <th field="tel" width="200" align="center" >联系电话</th>
        <th field="workplace" width="250" align="center">工作单位</th>
        <th field="regtime" width="150" align="center">注册日期</th>
...
<%--    </div>--%>
    <div>
        &nbsp;真实姓名：&nbsp;<input type="text" id="truename" size="20"
