...
<table id="dg" title="教师信息管理" class="easyui-datagrid" pagination="true"
       ...
       url="${pageContext.request.contextPath}/api/teacher/listHoutai/${teacherId}" toolbar="#tb">
    <thead data-options="frozen:true">
    <tr>
        <th field="cb" checkbox="true" align="center"></th>

        <th field="tId" width="15%" align="center" hidden="true">tId</th>
...
<script type="text/javascript">
    ...
    function openBeiShiZheModifyDialog() {
       ...
       // var ue = UE.getEditor('myEditor');
        ...
        url = "${pageContext.request.contextPath}/api/teacher/"
            + row.tId;
    }
...
<div id="dlg2" class="easyui-dialog"
    ...
    <form id="fm2" method="post">
        <table >
            ...
            <tr>
                <td>登陆密码：</td>
                <td><input type="text" id="tpwd" name="tpwd"
                           class="easyui-validatebox" required="true"/>&nbsp;<font
                        color="red">*</font>
                </td>
            </tr>
